...
@section('content')
  ...
  <div class="dd-layout-demo-wrapper">
    <div class="dd-layout-demo-placeholder">
      <img src="{{ asset('assets/img/layouts/layout-collapsed-menu-' . $configData['theme'] . '.png') }}" class="img-fluid"
    ...
    <div class="dd-layout-demo-info">
      ...
      <div class="alert alert-primary mt-6" role="alert"><span class="fw-medium">Important:</span> If you have enabled
        localStorage then the menu (navigation) will be synced with localStorage value.</div>
    </div>
  </div>
  <!--/ Layout Demo -->
