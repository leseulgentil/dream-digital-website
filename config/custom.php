...
return [
  'custom' => [
    ...
    'hasCustomizer' => false, // Enable/Disable customizer: true (default) or false — DISABLED for Dream Digital (S2). Full removal in S6.
    'displayCustomizer' => false, // Display customizer UI: true (default) or false — DISABLED for Dream Digital (S2). Full removal in S6.
