                ...
                <div class="d-flex border rounded position-relative pe-0">
                  <div class="row w-100 p-6 g-6">
                    ...
                    <div class="col-md-3 col-12 mb-md-0 mb-4">
                      ...
                      <input type="text" class="form-control invoice-item-price mb-5" value="24" placeholder="24"
                        min="12" />
                    ...
                    <div class="col-md-2 col-12 mb-md-0 mb-4">
                      ...
                      <input type="text" class="form-control invoice-item-qty" value="1" placeholder="1"
                        min="1" max="50" />
                    </div>
                  ...
                  <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                    ...
                    <div class="dropdown">
                      <i class="icon-base bx bx-cog icon-lg cursor-pointer more-options-dropdown" role="button"
      ...
      <div class="card mb-6">
        <div class="card-body">
          ...
          <button class="btn btn-success d-grid w-100" data-bs-toggle="offcanvas"
            ...
            <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                class="icon-base bx bx-dollar icon-sm me-1"></i>Add Payment</span>
          </button>
        </div>
      </div>
      <div>
