  ...
  <div class="authentication-wrapper authentication-cover">
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-4 align-items-center justify-content-end p-5 pe-0">
        <div class="w-px-400">
          <img src="{{ asset('assets/img/illustrations/create-account-' . $configData['theme'] . '.png') }}"
            class="img-fluid" alt="multi-steps" width="600" data-app-dark-img="illustrations/create-account-dark.png"
                  ...
                  <div class="row g-6">
                    ...
                    <div class="col-12 d-flex justify-content-between">
                      ...
                      <button class="btn btn-primary btn-next"><span
                          class="align-middle d-sm-inline-block d-none me-sm-2 me-0">Next</span> <i
                          class="icon-base bx bx-right-arrow-alt icon-sm me-sm-n2"></i></button>
                    </div>
                  </div>
                </div>
                <!-- Personal Info -->
